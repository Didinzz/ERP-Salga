// components/Kasir/Partials/ProductCard.jsx
...
export default function ProductCard({ product, onAdd }) {
    return (
        <div
            ...
            className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg group flex flex-col h-full"
        >
            {/* Image Section */}
            ...
            <div className="p-4 flex flex-col flex-1 justify-between">
                ...
                <div className="space-y-2">
                    ...
                    <button
                        className="w-full py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold text-sm hover:from-blue-700 hover:to-blue-800 transition-all shadow-md flex items-center justify-center gap-2 active:scale-95"
                    >
